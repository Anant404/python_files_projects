...
def getWordScore(word, n):
    ...
    for i in range(len(word)):
            ...
            score  = SCRABBLE_LETTER_VALUES[word[i]] + score
...
def updateHand(hand, word):
    ...
    # TO DO ... <-- Remove this comment when you code this function
    def check(hand, letter):
        """ checks if the letter is in the keys of the dictionary hand
        """
        for i in hand.keys():
            if i == letter :
                if hand[i]>0:
...
def playGame(wordList):
    ...
    while choice != 'e':
        ...
        elif choice != 'r' and  choice != 'n'and choice != 'e':
